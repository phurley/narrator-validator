...
pub use ruleset::{
    ...
    ANSWER_DECK_TAG_ID_MAX, ANSWER_DECK_TAG_ID_MIN, STANDARD_MYSTERY_RULESET_ID,
    ...
    STANDARD_MYSTERY_RULESET_VERSION_8, STANDARD_MYSTERY_RULESET_VERSION_9,
};
...
pub const STORY_FORMAT_VERSION: &str = "3.12.0";
